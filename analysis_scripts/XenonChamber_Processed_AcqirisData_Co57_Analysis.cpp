...
void XenonChamber_Processed_AcqirisData_Co57_Analysis()
{
    using namespace std;
    ...
    string ROOT_File = "Run045_Co57_ProcessedData.root";
    ...
    hist_S1->SetTitle("Run035 S1 from ^{57}Co Calibration ");
    ...
    const int  TopPMT_BinNbr = 100;
    
    Float_t  TopPMT_Hist_StartValue = 0;
    Float_t  TopPMT_Hist_EndValue   = 100;
    
    //gStyle->SetHistLineWidth(3);
    
    //TH1F         *TopPMT_S1 = new TH1F[TopPMT_HistNbr];
    //TH1F         *BtmPMT_S1 = new TH1F("BtmPMT_S1", "", 500, 0, 2000);
	...
	std::cout<<"Total Saturated Event#: "<<SaturEvtNbr<<", the ratio: "<<double(SaturEvtNbr)/double(EntryNbr)<<std::endl;
    ...
    c0->SaveAs("ScENE_XenonChamber_Run035_Co57_S1_Spectrum.pdf");
    c0->SaveAs("ScENE_XenonChamber_Run035_Co57_S1_Spectrum.eps");
